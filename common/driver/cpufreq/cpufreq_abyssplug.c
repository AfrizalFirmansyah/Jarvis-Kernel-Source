...
/* greater than 75% avg load across online CPUs increases frequency */
#define DEFAULT_UP_FREQ_MIN_LOAD			(75)

/* Keep 25% of idle under the up threshold when decreasing the frequency */
...
#define DEFAULT_HOTPLUG_OUT_SAMPLING_PERIODS		(16)
